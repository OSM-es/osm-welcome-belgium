...
$welcome_bottom['en']['tell_us_pref_lang'] = 'To let us know in which language you’d like to receive messages from OpenStreetMap Belgium, you can use one of the links below.';

$welcome_bottom['nl']['nl'] = 'Nederlands';
$welcome_bottom['nl']['fr'] = 'Frans';
$welcome_bottom['nl']['en'] = 'Engels';
$welcome_bottom['nl']['de'] = 'Duits';

$welcome_bottom['fr']['nl'] = 'néerlandais';
$welcome_bottom['fr']['fr'] = 'français';
$welcome_bottom['fr']['en'] = 'anglais';
$welcome_bottom['fr']['de'] = 'allemand';

$welcome_bottom['en']['nl'] = 'Dutch';
$welcome_bottom['en']['fr'] = 'French';
